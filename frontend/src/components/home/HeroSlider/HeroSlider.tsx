                    ...
                    <div className="hero-slider__text">
                        ...
                        <div className="hero-slider__buttons">
                            <button
                                ...
                                onClick={() => { window.location.href = safeLink(slide.primaryLink, "/customize"); }}
                            >
                                {primary}
                            </button>
                            <button
                                ...
                                onClick={() => { window.location.href = safeLink(slide.secondaryLink, "/collections"); }}
                            >
                                {secondary}
                            </button>
                        </div>
            ...
            {slides.length > 1 && (
                <>
                    <button
                        ...
                        onClick={() => setCurrent((v) => v === 0 ? slides.length - 1 : v - 1)}
                    ...
                    <button
                        ...
                        onClick={() => setCurrent((v) => (v + 1) % slides.length)}
                    ...
                    <div className="hero-slider__dots">
                        {slides.map((x, i) => (
                            <button
                                type="button"
                                key={x.id}
                                className={i === current ? "hero-slider__dot hero-slider__dot--active" : "hero-slider__dot"}
