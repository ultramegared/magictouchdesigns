...
function LoveRomancePage() {
    ...
    const t =
        translations[language].loveRomance;
            ...
            const loadProducts =
                async () => {
                    ...
                    try {
                        ...
                        const response =
                            await fetch(
                                `${API_BASE_URL}/api/collections/love-romance/products`
                            );
                        ...
                        console.error(
                            "Unable to load Love & Romance products:",
                            error
                        );
                            ...
                            <>
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="love-romance-product__body">
                                                            ...
                                                            <div className="love-romance-product-options">


                                                                {/* COLOR */}

                                                                <div className="love-romance-product-options__group">


                                                                    <span className="love-romance-product-options__label">
                                                                    ...
                                                                    <div className="love-romance-product-options__colors">


                                                                        <button
                                                                            type="button"
                                                                            className={
                                                                                `love-romance-color-button love-romance-color-button--white ${
                                                                                    options.color ===
                                                                                    "White"
                                                                                        ? "is-selected"
                                                                                        : ""
                                                                        ...
                                                                        <button
                                                                            type="button"
                                                                            className={
                                                                                `love-romance-color-button love-romance-color-button--black ${
                                                                                    options.color ===
                                                                                    "Black"
                                                                                        ? "is-selected"
                                                                                        : ""
                                                                ...
                                                                <div className="love-romance-product-options__group">
                                                                    ...
                                                                    <div className="love-romance-product-options__sizes">


                                                                        <button
                                                                            type="button"
                                                                            className={
                                                                                `love-romance-size-button ${
                                                                                    options.size ===
                                                                                    "11 oz"
                                                                                        ? "is-selected"
                                                                                        : ""
...

                                {
                                    totalPages > 1 && (
                                        ...
                                        <div className="love-romance-pagination">
