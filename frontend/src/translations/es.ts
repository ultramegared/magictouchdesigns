...
export const es = {
    ...
    forgotPassword: {
        ...
        description:
            "Ingresa el Gmail asociado a tu cuenta y te enviaremos un enlace de recuperación.",
        email: "Gmail",
        emailPlaceholder: "Ingresa tu dirección de Gmail",
        sendLink: "ENVIAR ENLACE DE RECUPERACIÓN",
        successMessage:
            "Si existe una cuenta asociada a ese Gmail, hemos enviado un enlace de recuperación.",
    ...
    register: {
        ...
        description:
            "Crea una cuenta y comienza tu experiencia en Magic Touch Designs.",
    ...
    collections: {
        ...
        cards: {
            ...
            specialOccasions: {
                ...
                description:
                    "Celebra los momentos más importantes de la vida.",
            },
        },
        ...
        featured: {
            ...
            title: "EDICIÓN AMOR",
            description:
                "Diseñada para momentos que merecen ser recordados.",
        ...
        benefits: {
            premiumQuality: {
                title: "CALIDAD PREMIUM",
                description:
                    "Materiales premium y acabados de alta calidad.",
            },
            ...
            customDesigns: {
                ...
                description:
                    "Diseños personalizados creados especialmente para ti.",
            },

            securePayment: {
                title: "PAGO SEGURO",
                description:
                    "Pagos seguros y protección de tus datos.",
            },
        },
    },
